...
class SLM_List_Licenses extends WP_List_Table
{
    ...
    function get_sortable_columns()
    {
        $sortable_columns = array(
            ...
            'product_ref'   => array('product_ref', true),
            'txn_id'        => array('txn_id', true),
            'lic_status'    => array('lic_status', true),
            //'current_ver'   => array('current_ver', true),
            'date_expiry'   => array('date_expiry', true),
    ...
    function prepare_items()
    {
        ...
        $do_search = $wpdb->prepare("SELECT * FROM " . $license_table . " WHERE `license_key` LIKE '%%%s%%' OR `email` LIKE '%%%s%%' OR `lic_status` LIKE '%%%s%%' OR `first_name` LIKE '%%%s%%' OR `last_name` LIKE '%%%s%%' OR `txn_id` LIKE '%%%s%%'", $search_term, $search_term, $search_term, $search_term, $search_term, $search_term);
