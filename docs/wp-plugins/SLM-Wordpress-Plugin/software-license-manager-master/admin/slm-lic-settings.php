...
?>
    ...
    if (isset($_POST['slm_save_settings'])) {
        ...
        $options = array(
			...
			'slm_meraf_prod_panel'      => trim($_POST['slm_meraf_prod_panel']),
            ...
            <form method="post" action="" class="wrap">
                ...
                <div class="slm-postbox wrap integrations hidepanel <?php echo ($tab == 'integrations') ? 'showpanel' : '' ?>">
                    <div class="inside">
                        <table class="form-table">
                            <tr valign="top">
                                <th scope="row"> <?php _e('MERAF Production Panel URL (with trailing slash)', 'softwarelicensemanager'); ?></th>
                                <td>
									<textarea name="slm_meraf_prod_panel" rows="2" cols="80"><?php 
										if (isset($options['slm_meraf_prod_panel']) && $options['slm_meraf_prod_panel'] != '') {
											echo $options['slm_meraf_prod_panel'];											
										}
										?></textarea>
									<p class=" description">Integration with MERAF Production Panel : Portal to manage products with ease.</p>
                                </td>
                            </tr>
                            <tr valign="top">
