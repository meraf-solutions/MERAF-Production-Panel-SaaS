...
<html lang="en" <?php $dir = service('request')->getLocale() === 'ar' ? 'rtl' : 'ltr'; ?> dir="<?= $dir ?>">
    ...
    <head>
        ...
        <title><?= lang('Pages.pageNotFound') ?></title>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-md-12 text-center">
                        <img src="<?= base_url('assets/images/404.svg') ?>" style="max-width: 500px;" alt="Eror 404">
                        <div class="text-uppercase mt-4 display-5 fw-semibold"><?= lang('Pages.pageNotFound') ?></div>
                        <div class="text-capitalize text-dark mb-4 error-page"></div>
                        <p class="text-muted para-desc mx-auto">
							<?php if (ENVIRONMENT !== 'production') : ?>
								<?= nl2br(esc($message)) ?>
							<?php else : ?>
								<?= lang('Pages.sorryCannotFind') ?>
							<?php endif; ?>						
						</p>
                    </div><!--end col-->
                </div><!--end row-->
